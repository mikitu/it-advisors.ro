...
export interface ApiBlogCategoryBlogCategory
  ...
  info: {
    description: 'Categorii pentru articolele de blog';
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Articole dintr-o comand\u0103';
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    billingCounty: Schema.Attribute.String;
    billingPostalCode: Schema.Attribute.String;
    companyCUI: Schema.Attribute.String;
    companyName: Schema.Attribute.String;
    companyRegCom: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductCategoryProductCategory
  ...
  info: {
    description: 'Categorii de produse IT';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Produse IT (hardware, software, cloud)';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Servicii IT oferite de companie';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSolutionSolution extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pachete de servicii IT';
...
export interface ApiVerificationCodeVerificationCode
  ...
  info: {
    description: 'Email verification codes for order history access';
