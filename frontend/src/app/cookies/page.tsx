      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-600 prose-li:text-gray-600">
            ...
            <ul>
              <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-[#2e6932] hover:underline">Google Chrome</a></li>
              <li><a href="https://support.mozilla.org/ro/kb/cookies-informatii-site-uri-stocate-calculator" target="_blank" rel="noopener noreferrer" className="text-[#2e6932] hover:underline">Mozilla Firefox</a></li>
              <li><a href="https://support.apple.com/ro-ro/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-[#2e6932] hover:underline">Safari</a></li>
              <li><a href="https://support.microsoft.com/ro-ro/microsoft-edge/ștergerea-modulelor-cookie-în-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-[#2e6932] hover:underline">Microsoft Edge</a></li>
            </ul>

            <div className="bg-[#2e6932]/10 border border-[#2e6932]/20 p-6 rounded-xl not-prose mt-8">
              <p className="text-[#1e4a22]">
            ...
            <p>
              ...
              <a href="mailto:contact@it-advisors.ro" className="text-[#2e6932] hover:underline">contact@it-advisors.ro</a>
            </p>
