        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-600 prose-li:text-gray-600">
            ...
            <p>
              ...
              Pentru detalii complete, consultați <a href="/gdpr" className="text-blue-600 hover:underline">pagina GDPR</a>.
            </p>
            ...
            <div className="bg-gray-50 p-6 rounded-xl not-prose">
              <p className="text-gray-600">Email: <a href="mailto:protectiedate@it-advisors.ro" className="text-blue-600 hover:underline">protectiedate@it-advisors.ro</a></p>
              <p className="text-gray-600">Telefon: <a href="tel:+40728691520" className="text-blue-600 hover:underline">+40 (728) 691 520</a></p>
