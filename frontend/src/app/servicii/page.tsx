...
export default async function ServiciiPage() {
  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#2e6932] transition-colors">
                  {service.title}
                </h2>
                ...
                <div className="mt-6 flex items-center text-[#2e6932] font-medium opacity-0 group-hover:opacity-100 transition-opacity">
                  Detalii serviciu
      ...
      {/* CTA */}
      <section className="py-16 bg-[#2e6932]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex px-8 py-4 bg-white text-[#2e6932] font-semibold rounded-xl hover:bg-gray-100 transition-colors"
          >
