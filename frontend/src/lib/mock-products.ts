...
export const mockProducts: Product[] = [
  {
    ...
    brand: "Microsoft", popularity: 95, featured: true, order: 1,
    category: { id: 1, documentId: "c1", name: "Software", order: 1 },
  },
  {
    ...
    brand: "Microsoft", popularity: 98, featured: true, order: 2,
    category: { id: 1, documentId: "c1", name: "Software", order: 1 },
  },
  {
    ...
    brand: "Microsoft", popularity: 85, featured: false, order: 3,
    category: { id: 1, documentId: "c1", name: "Software", order: 1 },
  },
  {
    ...
    brand: "Microsoft", popularity: 60, featured: false, order: 4,
    category: { id: 1, documentId: "c1", name: "Software", order: 1 },
  },
  {
    ...
    brand: "Sophos", popularity: 75, featured: true, order: 5,
    category: { id: 2, documentId: "c2", name: "Securitate", order: 2 },
  },
  {
    ...
    brand: "Dell", popularity: 70, featured: false, order: 6,
    category: { id: 3, documentId: "c3", name: "Servere", order: 3 },
  },
  {
    ...
    brand: "HP", popularity: 65, featured: false, order: 7,
    category: { id: 3, documentId: "c3", name: "Servere", order: 3 },
  },
  {
    ...
    brand: "Cisco", popularity: 55, featured: false, order: 8,
    category: { id: 4, documentId: "c4", name: "Rețelistică", order: 4 },
  },
  {
    ...
    brand: "APC", popularity: 80, featured: true, order: 9,
    category: { id: 5, documentId: "c5", name: "Infrastructură", order: 5 },
  },
  {
    ...
    brand: "VMware", popularity: 72, featured: false, order: 10,
    category: { id: 6, documentId: "c6", name: "Cloud", order: 6 },
  },
  {
    ...
    brand: "Acronis", popularity: 68, featured: false, order: 11,
    category: { id: 7, documentId: "c7", name: "Backup", order: 7 },
  },
  {
    ...
    brand: "Ubiquiti", popularity: 88, featured: true, order: 12,
    category: { id: 4, documentId: "c4", name: "Rețelistică", order: 4 },
  },
];

// Extract unique brands and categories for filters
export const mockBrands = [...new Set(mockProducts.map(p => p.brand).filter(Boolean))] as string[];
export const mockCategories = [...new Map(
  mockProducts.filter(p => p.category).map(p => [p.category!.id, p.category!])
).values()];
