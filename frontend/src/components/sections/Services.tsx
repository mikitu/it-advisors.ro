...
const colorClasses = {
  blue: { bg: "bg-emerald-100", text: "text-emerald-600", hover: "group-hover:bg-emerald-600" },
  ...
  cyan: { bg: "bg-teal-100", text: "text-teal-600", hover: "group-hover:bg-teal-600" },
    ...
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Servicii</span>
