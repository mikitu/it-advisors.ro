  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-[#2e6932]/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-1/2 -left-40 w-[400px] h-[400px] bg-[#28504a]/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-[#2e6932]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#2e6932]/20 text-[#4a9c50] rounded-full text-sm font-medium mb-6 backdrop-blur-sm border border-[#2e6932]/30">
          ...
          <div className="hidden lg:block relative">
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              {/* Main card */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#2e6932] to-[#28504a] rounded-3xl transform rotate-3 opacity-50" />
              <div className="absolute inset-0 bg-slate-800/90 backdrop-blur-sm rounded-3xl border border-white/10 p-8 flex flex-col justify-center">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-[#2e6932]/20 rounded-xl flex items-center justify-center">
                      <svg className="w-6 h-6 text-[#3d8a42]" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-[#28504a]/20 rounded-xl flex items-center justify-center">
                      <svg className="w-6 h-6 text-[#3d8a42]" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
